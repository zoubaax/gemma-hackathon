...
/**
 * drug-discovery-search Search via Valyu API
 * Full-text search across multiple data sources with semantic search capabilities
 */
...
/**
 * Search multiple sources via Valyu API
 */
...
(async () => {
  ...
  if (command === 'setup') {
    ...
    if (!query) {
      ...
      result = await search(query, maxResults);
    }
  }
